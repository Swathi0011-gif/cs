...
import { Upload, FileText, Send, Loader2, Bot, User, Paperclip, ArrowLeft } from "lucide-react";
...
export default function WorkspaceDetailPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="h-[calc(100vh-73px)] grid grid-cols-12 gap-6 p-6 max-w-[1600px] mx-auto">
                {/* Sidebar - Documents */}
